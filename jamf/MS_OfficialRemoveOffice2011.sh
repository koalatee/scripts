...
## updated by jjourney 04/2017 to reflect some dept specific changes
## this is from https://github.com/pbowden-msft/Remove2011/blob/master/Remove2011
## Changes:
## Force keep office data (for Outlook)
## change dockutil to $dept specific location
...
## Path constants
PATH_DOCKUTIL="/usr/local/bin/dockutil"
...
PATH_RDP="/Applications/Remote Desktop Connection.app"
PATH_COMMUNICATOR="/Applications/Microsoft Communicator.app"
PATH_MESSENGER="/Applications/Microsoft Messenger.app"
...
function CheckRunning2011 {
    ...
    CheckRunning "$PATH_COMMUNICATOR" "Microsoft Communicator"
    CheckRunning "$PATCH_MESSENGER" "Microsoft Messenger"
}
...
function ForceQuit2011 {
    ...
    ForceTerminate "$PATH_COMMUNICATOR" "Microsoft Communicator"
    ForceTerminate "$PATH_MESSENGER" "Microsoft Messenger"
    ForceTerminate "$PATH_RDP" "Microsoft RDP"
...
function Remove2011Preferences {
	...
	RemovePref "$USER_HOME/Library/Preferences/com.microsoft.Word.plist"
	RemovePref "$USER_HOME/Library/Preferences/com.microsoft.Excel.plist"
	RemovePref "$USER_HOME/Library/Preferences/com.microsoft.Powerpoint.plist"
	RemovePref "$USER_HOME/Library/Preferences/com.microsoft.Outlook.plist"
	RemovePref "$USER_HOME/Library/Preferences/com.microsoft.outlook.databasedaemon.plist"
	RemovePref "$USER_HOME/Library/Preferences/com.microsoft.outlook.office_reminders.plist"
	RemovePref "$USER_HOME/Library/Preferences/com.microsoft.DocumentConnection.plist"
	RemovePref "$USER_HOME/Library/Preferences/com.microsoft.office.setupassistant.plist"
	RemovePref "$USER_HOME/Library/Preferences/com.microsoft.office.plist"
	RemovePref "$USER_HOME/Library/Preferences/com.microsoft.error_reporting.plist"
	RemovePref "$USER_HOME/Library/Preferences/ByHost/com.microsoft.Word.*.plist"
	RemovePref "$USER_HOME/Library/Preferences/ByHost/com.microsoft.Excel.*.plist"
	RemovePref "$USER_HOME/Library/Preferences/ByHost/com.microsoft.Powerpoint.*.plist"
	RemovePref "$USER_HOME/Library/Preferences/ByHost/com.microsoft.Outlook.*.plist"
	RemovePref "$USER_HOME/Library/Preferences/ByHost/com.microsoft.outlook.databasedaemon.*.plist"
	RemovePref "$USER_HOME/Library/Preferences/ByHost/com.microsoft.DocumentConnection.*.plist"
	RemovePref "$USER_HOME/Library/Preferences/ByHost/com.microsoft.office.setupassistant.*.plist"
	RemovePref "$USER_HOME/Library/Preferences/ByHost/com.microsoft.registrationDB.*.plist"
	RemovePref "$USER_HOME/Library/Preferences/ByHost/com.microsoft.e0Q*.*.plist"
	RemovePref "$USER_HOME/Library/Preferences/ByHost/com.microsoft.Office365.*.plist"
	if (( $PREFCOUNT > 0 )); then
		ConsoleMessage "${TEXT_GREEN}Success${TEXT_NORMAL}"
	else
		ConsoleMessage "${TEXT_YELLOW}Not detected${TEXT_NORMAL}"
...
function CleanDock {
	...
	sudo "$PATH_DOCKUTIL" --remove "file:///Applications/Microsoft%20Office%202011/Microsoft%20Document%20Connection.app/" --no-restart "$USER_HOME"
	sudo "$PATH_DOCKUTIL" --remove "file:///Applications/Microsoft%20Office%202011/Microsoft%20Word.app/" --no-restart "$USER_HOME"
	sudo "$PATH_DOCKUTIL" --remove "file:///Applications/Microsoft%20Office%202011/Microsoft%20Excel.app/" --no-restart "$USER_HOME"
	sudo "$PATH_DOCKUTIL" --remove "file:///Applications/Microsoft%20Office%202011/Microsoft%20PowerPoint.app/" --no-restart "$USER_HOME"
	sudo "$PATH_DOCKUTIL" --remove "file:///Applications/Microsoft%20Office%202011/Microsoft%20Outlook.app/" "$USER_HOME"
...
function MainLoop {
    ...
    RemoveComponent "$PATH_COMMUNICATOR" "Microsoft Communicator"
    RemoveComponent "$PATH_MESSENGER" "Microsoft Messenger"
    RemoveComponent "$PATH_RDP" "Microsoft RDP"
	...
	RemoveComponent "$USER_HOME/Library/Application Support/Microsoft/Office" "Application Support"
	# Remove Office 2011 caches
	RemoveComponent "$USER_HOME/Library/Caches/com.microsoft.browserfont.cache" "Browser Font Cache"
	RemoveComponent "$USER_HOME/Library/Caches/com.microsoft.office.setupassistant" "Setup Assistant Cache"
	RemoveComponent "$USER_HOME/Library/Caches/Microsoft/Office" "Office Cache"
	RemoveComponent "$USER_HOME/Library/Caches/Outlook" "Outlook Identity Cache"
	RemoveComponent "$USER_HOME/Library/Caches/com.microsoft.Outlook" "Outlook Cache"
	# Remove Office 2011 preferences
	Remove2011Preferences
	# Remove or rename Outlook 2011 identities and databases
	if [ $PRESERVE_DATA = false ]; then
		RemoveComponent "$USER_HOME/Documents/Microsoft User Data/Office 2011 Identities" "Outlook Identities and Databases"
		RemoveComponent "$USER_HOME/Documents/Microsoft User Data/Saved Attachments" "Outlook Saved Attachments"
		RemoveComponent "$USER_HOME/Documents/Microsoft User Data/Outlook Sound Sets" "Outlook Sound Sets"
	else
		PreserveComponent "$USER_HOME/Documents/Microsoft User Data/Office 2011 Identities" "Outlook Identities and Databases"
		PreserveComponent "$USER_HOME/Documents/Microsoft User Data/Saved Attachments" "Outlook Saved Attachments"
		PreserveComponent "$USER_HOME/Documents/Microsoft User Data/Outlook Sound Sets" "Outlook Sound Sets"
	fi
